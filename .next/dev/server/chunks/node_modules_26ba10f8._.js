...
var GoogleSpreadsheetCell = class {
	...
	*/ _markDeleted() {
    ...
    set value(newValue) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isBoolean$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isBoolean"])(newValue)) this._draftData.valueType = "boolValue";
        else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isString$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isString"])(newValue)) if (newValue.substring(0, 1) === "=") this._draftData.valueType = "formulaValue";
        else this._draftData.valueType = "stringValue";
        else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isFinite$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFinite"])(newValue)) this._draftData.valueType = "numberValue";
	...
	*/ get hyperlink() {
    ...
    _getFormatParam(param) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$object$2f$get$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["get"])(this._draftData, `userEnteredFormat.${param}`)) throw new Error("User format is unsaved - save the cell to be able to read it again");
        return Object.freeze(this._rawData.userEnteredFormat[param]);
    }
    _setFormatParam(param, newVal) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$predicate$2f$isEqual$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isEqual"])(newVal, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$object$2f$get$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["get"])(this._rawData, `userEnteredFormat.${param}`))) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$object$2f$unset$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unset"])(this._draftData, `userEnteredFormat.${param}`);
        else {
	...
	*/ _getUpdateRequest() {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$object$2f$get$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["get"])(this._draftData, "userEnteredFormat.backgroundColor")) delete format.backgroundColorStyle;
        return {
            updateCells: {
                rows: [
                    {
...
var GoogleSpreadsheetWorksheet = class {
	...
	*/ resetLocalCache(dataOnly) {
    ...
    getCell(rowIndex, columnIndex) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$object$2f$get$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["get"])(this._cells, `[${rowIndex}][${columnIndex}]`)) throw new Error("This cell has not been loaded yet");
    ...
    async loadCells(sheetFilters) {
        ...
        const filtersArrayWithSheetId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$array$2f$map$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])(filtersArray, (filter)=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isString$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isString"])(filter)) {
                if (filter.startsWith(this.a1SheetName)) return filter;
                return `${this.a1SheetName}!${filter}`;
            }
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isObject$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isObject"])(filter)) {
    ...
    async saveCells(cellsToUpdate) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$array$2f$compact$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compact"])(requests).length) throw new Error("At least one cell must have something to update");
    ...
    _processHeaderRow(rows) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$array$2f$compact$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compact"])(this.headerValues).length) throw new Error("All your header cells are blank - fill the first row with header values before trying to interact with rows");
    ...
    async setHeaderRow(headerValues, headerRowIndex) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$array$2f$compact$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compact"])(trimmedHeaderValues).length) throw new Error("All your header cells are blank -");
    ...
    async addRows(rows, options = {}) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$array$2f$forEach$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__forEach__as__each$3e$__["each"])(rows, (row)=>{
            let rowAsArray;
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isArray$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isArray"])(row)) rowAsArray = row;
...
async function getRequestAuthConfig(auth) {
    if ("getRequestHeaders" in auth) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isObject$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isObject"])(headers)) return {
            headers
        };
...
*/ var GoogleSpreadsheet = class GoogleSpreadsheet {
	...
	* */ async deleteNamedRange(namedRangeId) {
    ...
    /** fetch cell data into local cache */ async loadCells(filters) {
        ...
        const dataFilters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$array$2f$map$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["map"])(filtersArray, (filter)=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isString$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isString"])(filter)) return readOnlyMode ? filter : {
                a1Range: filter
            };
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isObject$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isObject"])(filter)) {
        ...
        if (this.authMode === AUTH_MODES.API_KEY) {
            ...
            dataFilters.forEach((singleFilter)=>{
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$es$2d$toolkit$2f$dist$2f$compat$2f$predicate$2f$isString$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isString"])(singleFilter)) throw new Error("Only A1 ranges are supported when fetching cells with read-only access (using only an API key)");
	...
	*/ async searchDeveloperMetadata(filters) {
    ...
    static async createNewSpreadsheetDocument(auth, properties) {
        ...
        const data = await (await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ky$2f$distribution$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].post(SHEETS_API_BASE_URL, {
            ...authConfig,
            json: {
                properties
            }
...
//# sourceMappingURL=node_modules_26ba10f8._.js.map